...
\begin{document}
	...
	\end{center}
		...
		\section{Experience}
	\cventry{To be joined}{Quantum Intern}{\textnormal{IBM Research Lab}}{Bangalore.}{}{$\bullet$ Under IISc-IBM AI Horizon Network}
	
	
	\section{Education}
	\cventry{07/2021--Present}{Masters in Physics}{\textnormal{Indian Institute of Science}}{Bangalore.}{}{IISc stands distinguished as the top-ranked research institution in the nation, as per the Ministry of Education, Government of \href{https://www.nirfindia.org/2023/ResearchRanking.html}{India's research rankings}.  \\ 
		$\bullet$ Three-year MS program with a dedicated year-long research focus $\bullet$ CGPA : 9.10/10  (max. typically $\sim$ 9.4) $\bullet$ On track for Distinction in the Major}  % arguments 3 to 6 can be left empty
	\cventry{06/2018-06/2021}{Bachelor in Physics}{\textnormal{Banaras Hindu University}}{Varanasi.}{}{BHU holds the 6th position among universities in the country, according to the Ministry of Education, Government of \href{https://www.nirfindia.org/2023/ResearchRanking.html}{India's research rankings}.\\ $\bullet$ CGPA : 9.15/10 $\bullet$ Passed in First Division with Distinction}
	
	\section{Master thesis}
	
	\cvitem{Title}{Quantum walk based simulations \& algorithms}
	\cvitem{Supervisor}{Prof. CM Chandrashekar}
	\cvitem{Description}{To be decided}
	
	
	\section{Research activity}
	\cvitem{Brief description}{As a researcher at the `Quantum Optics and Quantum Information Lab', my work revolves around the exciting fields of quantum computation and quantum information. Within this broad area, my research focuses on simulating quantum phenomena in nature and exploring their potential applications.  To achieve this, I primarily work with quantum walks, a powerful computational framework in quantum physics. Apart from these, my research has also focused on investigating the phenomenon of information scrambling and quantum chaos within complex many-body quantum systems.}
	...
	\cventry{[1]}{\textnormal{A. Bhattacharya, P.P. Nath \& H. Sahu, Speed limits to the growth of Krylov complexity in open quantum systems, (2024). \href{https://arxiv.org/abs/2403.03584}{arXiv:2403.03584 [quant-ph]}}}{}{}{}{\textcolor{blue}{All authors contributed equally to this work.}}
	...
	\cvitem{Indices}{h-index 2 total citations 90 (Feb 2024), iNSPIRE-HEP}
	\cvitem{}{h-index 2 total citations 51 (Jan 2024), Google-Scholar}
	...
	\cventry{2023}{\textnormal{Semi-Finalist, \href{https://www.rhodeshouse.ox.ac.uk/scholarships/applications/india/}{Rhodes Scholarship}}} {}{}{}{$\bullet$ Recognized as a Semi-Finalist for the prestigious Rhodes Scholarship, representing the STEM category. $\bullet$ Advanced to the semi-final round in the highly competitive selection process for the Rhodes Scholarship $\bullet$ Acknowledged for exceptional academic and leadership qualities during the Rhodes Scholarship application process }
	
	\cventry{2021-Present}{\textnormal{IISC MS scholarship}}{}{}{}{$\bullet$ Beneficiary of the academic and financial provisions provided to Integrated PhD scholars at IISc Bangalore.}
	
	\cventry{2018-23}{\textnormal{\href{https://online-inspire.gov.in/}{INSPIRE Scholarship Awardee (SHE Program)}}}{}{}{}{$\bullet$ Awarded the prestigious INSPIRE Scholarship for Higher Education, a selective grant awarded to top $1\%$ performers in XII standard $\bullet$ Acknowledged for academic excellence in Natural or Basic Sciences, receiving financial support through the SHE program $\bullet$ Among top-ranking students nationally, recognized and supported by the Department of Science and Technology, Government of India }
	\cventry{2017}{\textnormal{\href{https://en.wikipedia.org/wiki/Free_laptop_distribution_scheme_of_the_Uttar_Pradesh_government}{State Government Academic Excellence Award}}}{}{}{}{$\bullet$ Acknowledged by the State Government for academic achievements in Class X $\bullet$ Awarded a laptop as a recognition of academic excellence   $\bullet$ Selected among top-performing students statewide for this merit-based honor}
	
	%$\bullet$ Awarded to top $1\%$ performers in XII standard.
	
	
	\section{Other skills}
	\mysubsection{Computer skills}
	\cvitem{OS}{Windows, Linux, Clusters}
	\cvitem{Languages}{Python, Processing3}
	\cvitem{Software}{Mathematica, \LaTeX, Matlab, Microsoft office, Origin, $\ldots$}
	\cvitem{Libraries}{Numpy, Scipy, Qiskit, QuSpin, QuTip, joblib, $\ldots$}
	...
	\cventry{2020-Present}{\textnormal{Contributor  on \href{https://stackexchange.com/users/16277143/young-kindaichi}{Physics Stack Exchange}}}{}{}{}{$\bullet$ Top $2\%$ overall $\bullet$ $11$K+ Reputation $\bullet$  $\sim 262$K people reached}
	...
	\cventry{2023}{\textnormal{IISC Annual Open Day}}{}{}{}{$\bullet$ On 4th March 2023 $\bullet$ Presented experiments and counselled youths for a career in science. }
