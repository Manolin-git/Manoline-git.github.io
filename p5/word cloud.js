...
series.data.setAll([
  ...
  { tag: "Quantum-algorithm", weight: 56.07 },
  { tag: "Information scrambling", weight: 48.24 },
  { tag: "Complexity", weight: 47.08 },
  { tag: "Quantum simulation", weight: 35.35 },
  { tag: "data search", weight: 33.91 },
  { tag: "genome sequencing", weight: 30.19 },
  ...
  { tag: "quantum circuits", weight: 9.55 },
  { tag: "quantum error correction", weight: 8.32 },
  { tag: "many-body system", weight: 7.03 },
  { tag: "spin-chain", weight: 6.75 },
  { tag: "quantum information", weight: 6.02 },
  { tag: "quantum communication", weight: 5.61 },
  { tag: "quantum optics", weight: 5.1 },
  ...
  { tag: "quantum operator", weight: 2.6 },
